...
" Buf Explorer use relative path
let g:bufExplorerShowRelativePath = 1


" Ctrl-P speedup using the_silver_searcher/cache
...
" Custom Ctrl-P and Nerdtree ignores
...
let g:syntastic_ruby_rubocop_exec = '/Users/loopmacbookpro/.rbenv/shims/ruby'
...
let g:indentLine_color_term = 53

let @q = 'oimport ipdb; ipdb.set_trace()'
